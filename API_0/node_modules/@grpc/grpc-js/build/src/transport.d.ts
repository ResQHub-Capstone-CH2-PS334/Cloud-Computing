...
import { SocketRef } from '@grpc/grpc-js/build/src/channelz';
...
import { Http2SubchannelCall, SubchannelCall, SubchannelCallInterceptingListener } from '@grpc/grpc-js/build/src/subchannel-call';
