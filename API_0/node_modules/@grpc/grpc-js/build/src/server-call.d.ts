...
import { Deserialize, Serialize } from '@grpc/grpc-js/build/src/make-client';
import { Metadata } from '@grpc/grpc-js/build/src/metadata';
import { ObjectReadable, ObjectWritable } from '@grpc/grpc-js/build/src/object-stream';
import { ChannelOptions } from '@grpc/grpc-js/build/src/channel-options';
import { StatusObject, PartialStatusObject } from '@grpc/grpc-js/build/src/call-interface';
...
export declare class Http2ServerCallStream<RequestType, ResponseType> extends EventEmitter {
    ...
    receiveUnaryMessage(encoding: string, next: (err: Partial<ServerStatusResponse> | null, request?: RequestType) => void): void;
