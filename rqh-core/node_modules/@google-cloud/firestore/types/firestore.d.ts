...
declare namespace FirebaseFirestore {
  ...
  export abstract class Filter {
     ...
     *     console.log(`Found document at ${documentSnapshot.ref.path}@google-cloud/firestore/types/v1beta1/firestore_client;
     * ```
     */
    static where(
      fieldPath: string | FieldPath,
     ...
     * disjunct@google-cloud/firestore/types/v1/firestore_clientnk Filter}s. A disjunction filter includes
     * a document i@google-cloud/firestore/types/v1/firestore_admin_clientiven {@link Filter}s.
     *
